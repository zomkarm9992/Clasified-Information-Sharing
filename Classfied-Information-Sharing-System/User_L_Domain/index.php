...
if($session->logged_in)
{
   ...
   echo "<br><br>";
    ...
    $sql="select flag from User_db where (User_1='$name' or User_2='$name')";
    $sql4="select flag from Request where (Sender='$name')";
    $row4=mysql_query($sql4);
    $val4=mysql_fetch_array($row4);
...
//     $d=implode($val);
	...
	if($val4=='')
	{
   echo "<ul><li><h2>&nbsp;&nbsp;&nbsp;&nbsp;<a href='request.php'>Request --</a></h2></li><li><h2>&nbsp;&nbsp;&nbsp;&nbsp;<a href='approval.php'>Approval --</a></h2></li></ul><br><br>";
   echo "[<a href=\"process.php\">Logout</a>]";
        }
	else
	{
		echo "<ul><li><h2>&nbsp;&nbsp;&nbsp;&nbsp;<a href='approval.php'>Approval --</a></h2></li></ul><br><br>";
		echo "[<a href=\"process.php\">Logout</a>]";	
	}
	}
	else
